...
import { addTechnicianAddress, addTechnicianDetails, createTechnician, findTechnicianByEmail, updateTechnicianPassword } from '../../models/technician/technician.query';
...
const setUpTechnician = async (req: Request, res: Response) => {
	try {
		...
		const setTechnician = { imageUrl, address, phone, brandsExpertise, subpartExpertise, workingDays, workingSlots };
