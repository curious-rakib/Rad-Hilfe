                    ...
                    <>
                        ...
                        <Box color={'accent'} p={7} mt={4}>
                            <Stack spacing={1}>
                                ...
                                <Text>Date opened: {date} {exactMonth} {year} </Text>
                            ...
                            <Box>
                                ...
                                <Flex mt={2} flexWrap="wrap" color={'black'} fontWeight={'semibold'} >
                                    {
                                        caseByIdState[0].order.bicycleParts.reduce((acc: any[], part: any) => {
                                        ...
                                        return <>
                                            <Flex color='third' my={3} >
                                                <Circle
                                                    ...
                                                    bg={categoryToColor[part.category as keyof typeof categoryToColor]} size={'25px'} mr={'8px'}>{" "}  </Circle>
                                                <HStack spacing={30}  >
                                                    <Text color={'white'} w={'55vw'}>{part.name} (x1)</Text>
