                    ...
                    <TabPanel mt={4}
...

                        {
                            ...
                            resolveCases.length < 1 ?
                                <>
                                    <Text style={{ textAlign: 'center', padding: '3.7rem', fontWeight: '700' }}>No resolved Issues</Text>
                                </> :
                                                ...
                                                <Box bg={'accent'} p={4} rounded={'2xl'}>
                                                    ...
                                                    >
                                                        ...
                                                        <Flex justifyContent="space-between" borderBottom="1px solid black" pl={3}>
                                                            <Box >
                                                                <h2 style={{ fontWeight: "bold", fontSize: "20px" }}>Case #{singleResolveCase.caseNumber}</h2>
                                                                <h6 style={{ fontSize: "12px", marginBottom: "10px" }}>Time to replace some parts...</h6>
                                                            </Box>
                                                            <Box >
                                                                <VStack mt={1}>
                                                                    <h6 style={{ fontSize: "12px", paddingTop: '1px' }}>{date} {month} {year}</h6>
...

                        {
                            ...
                            onGoingCases.length < 1 ?
                                ...
                                onGoingCases.map((singleOnGoingCase) => {
                                    ...
                                    const month = months[time.getMonth()];
                                    const year = time.getFullYear();
                                    const partNamesWithCategories: { name: string, category: keyof typeof categoryToColor }[] = [];
                                    const partPrice: any[] = [];
                                            ...
                                            <Link to={`/individual-cyclist-case/${singleOnGoingCase._id}`}  >
                                                ...
                                                <Box bg={'accent'} p={4} rounded={'2xl'}>
                                                    ...
                                                    >
                                                        ...
                                                        <Flex justifyContent="space-between" borderBottom="1px solid black" pl={3}>
                                                            <Box >
                                                                <h2 style={{ fontWeight: "bold", fontSize: "20px" }}>Case #{singleOnGoingCase.caseNumber}</h2>
                                                                <h6 style={{ fontSize: "12px", marginBottom: "10px" }}>Time to replace some parts...</h6>
                                                            </Box>
                                                            <Box >
                                                                <VStack mt={1}>
                                                        ...
                                                        <Flex mt={2} flexWrap="wrap" pl={2} fontWeight={'bold'} fontSize={'sm'}>
                                                            {partNamesWithCategories.map((part, index) => <>
                                                                <Box key={index} bg={categoryToColor[part.category]} m={1} p={2} px={4} borderRadius="10px">
